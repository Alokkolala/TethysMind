  ...
  const handleFileUpload = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    if (file) {
      ...
      reader.onloadend = async () => {
        ...
        toast.success('Диплом загружен на проверку');
      };
          ...
          <Card className="border-2 border-purple-300 dark:border-purple-700 bg-gradient-to-br from-purple-100/50 to-pink-100/50 dark:from-purple-950/30 dark:to-pink-950/30">
            <CardHeader>
              <div className="flex items-center gap-3">
                ...
                <div>
                  <CardTitle className="text-purple-700 dark:text-purple-300">Сила портфолио</CardTitle>
                  <p className="text-sm text-blue-600 dark:text-blue-400">
                    Общая оценка твоих достижений
                  </p>
                </div>
              </div>
            </CardHeader>
            <CardContent>
              <div className="space-y-4">
                <div className="flex items-center justify-between">
                  <span className="text-blue-600 dark:text-blue-400">Общая оценка</span>
                ...
                <div className="pt-4 border-t border-purple-200 dark:border-purple-800">
                  <div className="flex items-center gap-2 mb-3">
                    ...
                    <span className="text-base text-blue-700 dark:text-blue-300">Рост за месяц</span>
                  </div>
                  <div className="grid grid-cols-3 gap-3">
                    <div className="bg-emerald-100 dark:bg-emerald-900/30 p-3 rounded-lg text-center">
                      ...
                      <div className="text-xs text-blue-600 dark:text-blue-400 mt-1">предметов</div>
                    </div>
                    <div className="bg-violet-100 dark:bg-violet-900/30 p-3 rounded-lg text-center">
                      ...
                      <div className="text-xs text-blue-600 dark:text-blue-400 mt-1">дипломов</div>
                    </div>
                    <div className="bg-amber-100 dark:bg-amber-900/30 p-3 rounded-lg text-center">
                      ...
                      <div className="text-xs text-blue-600 dark:text-blue-400 mt-1">средний GPA</div>
                    </div>
                  </div>
                </div>
                ...
                <div className="grid grid-cols-3 gap-3 pt-4 border-t border-purple-200 dark:border-purple-800">
                  <div className="text-center p-3 bg-indigo-100 dark:bg-indigo-900/30 rounded-lg">
                    ...
                    <div className="text-xs text-blue-600 dark:text-blue-400">Предметов</div>
                  </div>
                  <div className="text-center p-3 bg-cyan-100 dark:bg-cyan-900/30 rounded-lg">
                    ...
                    <div className="text-xs text-blue-600 dark:text-blue-400">Экзаменов</div>
                  </div>
                  <div className="text-center p-3 bg-amber-100 dark:bg-amber-900/30 rounded-lg">
                    ...
                    <div className="text-xs text-blue-600 dark:text-blue-400">Дипломов</div>
                  </div>
                </div>
              </div>
            </CardContent>
            ...
            <CardHeader>
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <CardTitle className="text-indigo-700 dark:text-indigo-300">Табель</CardTitle>
                    <p className="text-sm text-blue-600 dark:text-blue-400">
                ...
                <Dialog>
                  ...
                  <DialogContent className="max-w-md">
                    <DialogHeader>
                      ...
                      <DialogDescription>Добавь свои предметы и оценки</DialogDescription>
                    </DialogHeader>
                    <div className="space-y-4">
            ...
            <CardContent>
              ...
              {subjects.length === 0 && (
                <p className="text-center text-blue-600 dark:text-blue-400 py-8">
                  Нажми "Изменить" чтобы добавить предметы
                </p>
              )}
            </CardContent>
          </Card>
            ...
            <CardHeader>
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-3">
                  ...
                  <CardTitle className="text-cyan-700 dark:text-cyan-300">Международные экзамены</CardTitle>
                </div>
                ...
                <Dialog>
                  ...
                  <DialogContent className="max-w-md">
                    <DialogHeader>
                      <DialogTitle>Баллы экзаменов</DialogTitle>
                      <DialogDescription>Введи свои результаты</DialogDescription>
                    </DialogHeader>
                    <div className="space-y-4">
                      <div className="space-y-2">
                        <Label>IELTS балл (0-9)</Label>
                        <Input
                          type="number"
                          min="0"
                          max="9"
                      ...
                      <Button className="w-full bg-cyan-600">Сохранить</Button>
                    </div>
                  </DialogContent>
                </Dialog>
              </div>
            ...
            <CardHeader>
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <CardTitle className="text-amber-700 dark:text-amber-300">Достижения</CardTitle>
                    <p className="text-sm text-blue-600 dark:text-blue-400">
                      {diplomas.filter(d => d.verified).length} проверено
                    </p>
                  </div>
                </div>
                ...
                <Dialog>
                  ...
                  <DialogContent className="max-w-md">
                    <DialogHeader>
                      ...
                      <DialogDescription>Загрузи фото диплома</DialogDescription>
                    </DialogHeader>
                    <div className="space-y-4">
                      <div className="space-y-2">
                      ...
                      <div className="space-y-2">
                        ...
                        <Select value={newDiplomaLevel} onValueChange={(value: any) => setNewDiplomaLevel(value)}>
                          ...
                          <SelectContent>
                            ...
                            <SelectItem value="republic">Республиканский</SelectItem>
                            <SelectItem value="international">Международный</SelectItem>
                          </SelectContent>
                        </Select>
                      </div>
                      <div>
                        <Label>Фото диплома</Label>
                        <label htmlFor="diploma-upload" className="cursor-pointer block mt-2">
                          <div className="border-2 border-dashed border-amber-400 rounded-lg p-6 text-center hover:bg-amber-50 dark:hover:bg-amber-950/20 transition-colors">
                            ...
                            <p className="text-sm text-amber-700 dark:text-amber-300">Загрузить</p>
                          </div>
                          <input
                            id="diploma-upload"
                            type="file"
            ...
            <CardContent>
              <div className="grid grid-cols-3 gap-3">
                <div className="p-3 bg-emerald-100 dark:bg-emerald-900/30 rounded-lg text-center">
                  <div className="text-xs text-blue-600 dark:text-blue-400 mb-1">Городские</div>
                ...
                <div className="p-3 bg-violet-100 dark:bg-violet-900/30 rounded-lg text-center">
                  <div className="text-xs text-blue-600 dark:text-blue-400 mb-1">Республ.</div>
                ...
                <div className="p-3 bg-amber-100 dark:bg-amber-900/30 rounded-lg text-center">
                  <div className="text-xs text-blue-600 dark:text-blue-400 mb-1">Междунар.</div>
