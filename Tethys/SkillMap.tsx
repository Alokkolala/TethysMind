...
export function SkillsMapPage() {
  ...
  const directions: DirectionData[] = [
    {
      ...
      skills: [
        ...
        { id: 'basics', name: 'Основы программирования', x: 900, y: 450, unlocked: false, connections: ['python', 'javascript'], level: 1,
        ...
        { id: 'python', name: 'Python', x: 1050, y: 300, unlocked: false, connections: ['django', 'data-science'], level: 2,
        ...
        { id: 'javascript', name: 'JavaScript', x: 1050, y: 600, unlocked: false, connections: ['react', 'nodejs'], level: 2,
        ...
        { id: 'django', name: 'Django', x: 1250, y: 200, unlocked: false, connections: ['fullstack'], level: 3,
        ...
        { id: 'data-science', name: 'Data Science', x: 1250, y: 400, unlocked: false, connections: ['ml'], level: 3,
        ...
        { id: 'react', name: 'React', x: 1250, y: 550, unlocked: false, connections: ['fullstack'], level: 3,
        ...
        { id: 'nodejs', name: 'Node.js', x: 1250, y: 700, unlocked: false, connections: ['fullstack'], level: 3,
        ...
        { id: 'ml', name: 'Machine Learning', x: 1400, y: 300, unlocked: false, connections: [], level: 4,
        ...
        { id: 'fullstack', name: 'Full Stack', x: 1400, y: 600, unlocked: false, connections: [], level: 4,
    ...
    },
    {
      ...
      color: '#8b5cf6',
      skills: [
        { id: 'center', name: 'Старт', x: 700, y: 450, unlocked: true, connections: ['arithmetic'], level: 0,
        ...
        { id: 'arithmetic', name: 'Арифметика', x: 900, y: 450, unlocked: false, connections: ['algebra', 'geometry'], level: 1,
        ...
        { id: 'algebra', name: 'Алгебра', x: 1050, y: 300, unlocked: false, connections: ['linear-algebra', 'calculus'], level: 2,
        ...
        { id: 'geometry', name: 'Геометрия', x: 1050, y: 600, unlocked: false, connections: ['trig', 'analytic-geo'], level: 2,
        ...
        { id: 'linear-algebra', name: 'Линейная алгебра', x: 1250, y: 200, unlocked: false, connections: ['advanced-math'], level: 3,
        ...
        { id: 'calculus', name: 'Математический анализ', x: 1250, y: 350, unlocked: false, connections: ['advanced-math'], level: 3,
        ...
        { id: 'trig', name: 'Тригонометрия', x: 1250, y: 550, unlocked: false, connections: ['analytic-geo'], level: 3,
        ...
        { id: 'analytic-geo', name: 'Аналитическая геометрия', x: 1250, y: 700, unlocked: false, connections: ['advanced-math'], level: 3,
        ...
        { id: 'advanced-math', name: 'Высшая математика', x: 1400, y: 450, unlocked: false, connections: [], level: 4,
    ...
    },
    {
      ...
      skills: [
        ...
        { id: 'basics', name: 'Основы изучения языков', x: 900, y: 450, unlocked: false, connections: ['english', 'chinese'], level: 1,
        ...
        { id: 'english', name: 'English (A1-B2)', x: 1050, y: 300, unlocked: false, connections: ['english-advanced', 'ielts'], level: 2,
        ...
        { id: 'chinese', name: '中文 (HSK 1-3)', x: 1050, y: 600, unlocked: false, connections: ['chinese-advanced'], level: 2,
        ...
        { id: 'english-advanced', name: 'English (C1-C2)', x: 1250, y: 200, unlocked: false, connections: ['polyglot'], level: 3,
        ...
        { id: 'chinese-advanced', name: '中文 (HSK 4-6)', x: 1250, y: 600, unlocked: false, connections: ['polyglot'], level: 3,
  ...
  const drawCanvas = () => {
    ...
    skills.forEach(skill => {
      ...
      ctx.fillText(skill.name, skill.x, textY);
  ...
  const unlockSkill = (skillId: string) => {
    ...
    if (skill) {
      toast.success(`⭐ Навык "${skill.name}" освоен!`, {
        description: 'Продолжай исследовать космос знаний!'
      });
    }
  };
  ...
  const handleMarkAsLearned = () => {
    ...
    if (selectedSkill.id === 'center') {
      toast.info('Стартовый навык уже разблокирован!');
      setSelectedSkill(null);
      return;
    }

    if (selectedSkill.unlocked) {
      toast.info('Этот навык уже изучен!');
      setSelectedSkill(null);
      return;
    }
    ...
    if (!hasUnlockedParent) {
      toast.error('Сначала изучи предыдущие навыки', {
        description: 'Следуй по пути знаний последовательно'
      });
      return;
    }
    ...
    <div ref={containerRef} className="fixed inset-0 bg-black overflow-hidden">
          ...
          <div className="flex items-center justify-between mb-3">
            <div className="flex items-center gap-4">
              <div className="flex items-center gap-2">
                ...
                <h1 className="text-2xl bg-gradient-to-r from-purple-400 via-blue-400 to-cyan-400 bg-clip-text text-transparent">
                  Карта навыков
                </h1>
              </div>
            ...
            <div className="flex items-center gap-2">
              <Button
                size="sm"
                variant="ghost"
                className="text-blue-300 hover:bg-blue-500/20 hover:text-blue-200"
              >
      ...
      <div className="absolute bottom-6 right-6 flex flex-col gap-2 z-10">
        <Button
          ...
          className="bg-slate-900/80 hover:bg-slate-800 backdrop-blur-md border border-blue-500/30 shadow-lg shadow-blue-500/20"
        >
      ...
      <div className="absolute bottom-6 left-6 z-10">
        <Badge className="bg-slate-900/80 backdrop-blur-md border-blue-500/30 text-blue-300">
          {Math.round(zoom * 100)}%
        </Badge>
      </div>
      ...
      <Dialog open={selectedSkill !== null} onOpenChange={(open) => !open && setSelectedSkill(null)}>
        <DialogContent className="max-w-2xl bg-slate-900/95 backdrop-blur-xl border-2 border-blue-500/30">
          <DialogHeader>
            <div className="flex items-center gap-3 mb-2">
              ...
              <div className="flex-1">
                <DialogTitle className="text-2xl text-white">{selectedSkill?.name}</DialogTitle>
          ...
          {selectedSkill && (
            <div className="space-y-4 mt-4">
              <div className="flex items-center gap-2">
                <Badge className={selectedSkill.unlocked ? 'bg-green-500/20 text-green-300 border-green-500/30' : 'bg-slate-700/50 text-slate-400'}>
                  {selectedSkill.unlocked ? '✓ Освоен' : '🔒 Заблокирован'}
                </Badge>
                <Badge className="bg-amber-500/20 text-amber-300 border-amber-500/30">
                  Уровень {selectedSkill.level}
                </Badge>
              </div>

              <div className="p-4 bg-blue-50 dark:bg-blue-950/30 rounded-lg">
                <h4 className="flex items-center gap-2 mb-2 text-blue-900 dark:text-blue-300">
                  <Info className="w-4 h-4" />
                  Подробное описание
                </h4>
                <p className="text-sm text-blue-800 dark:text-blue-200">{selectedSkill.detailedDescription}</p>
              </div>

              <div className="grid grid-cols-2 gap-4">
                {selectedSkill.prerequisites && (
                  <div className="p-3 bg-orange-50 dark:bg-orange-950/30 rounded-lg">
                    <div className="text-sm text-orange-700 dark:text-orange-400 mb-1">Требования</div>
                    <div className="text-sm text-orange-900 dark:text-orange-200">{selectedSkill.prerequisites}</div>
                  </div>
                )}
                {selectedSkill.outcomes && (
                  <div className="p-3 bg-green-50 dark:bg-green-950/30 rounded-lg">
                    <div className="text-sm text-green-700 dark:text-green-400 mb-1">Результаты</div>
                    <div className="text-sm text-green-900 dark:text-green-200">{selectedSkill.outcomes}</div>
                  </div>
                )}
              </div>
              ...
              {selectedSkill.connections.length > 0 && (
                <div>
                  <p className="text-xs text-slate-400 mb-2">Открывает путь к:</p>
              ...
              <div className="flex items-center justify-between pt-4 border-t border-slate-700">
                <div className="text-sm text-slate-400">
                  {selectedSkill.unlocked ? 'Навык уже изучен' : selectedSkill.id === 'center' ? 'Стартовый навык' : 'Нажмите кнопку для изучения'}
                </div>
